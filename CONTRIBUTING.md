...
Welcome to `predthread` contributor's guide.
...
If you experience bugs or general issues with `predthread`, please have a look
...
You can help improve `predthread` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`predthread` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `predthread`'s files. While this mechanism can
...
```
conda create -n predthread python=3 six virtualenv pytest pytest-cov
conda activate predthread
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/predthread.git
   cd predthread
   ```
...
5. Install [pre-commit]:
   ...
   `predthread` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/predthread
[issue tracker]: https://github.com/<USERNAME>/predthread/issues
